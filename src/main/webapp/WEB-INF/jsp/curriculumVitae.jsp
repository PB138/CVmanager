                            ...
                            <div class="col-xs-12 col-sm-4">
                                <figure>
                                    <img class="img-circle img-responsive" alt=""
                                         src="https://image.freepik.com/iconos-gratis/persona-silueta-de-negocios-con-corbata_318-49988.png"
                                         style="width: 219px;
    height: 219px;">
                                </figure>
                            </div>
                ...
                <div class="bs-callout bs-callout-danger">
                    ...
                    <table class="table table-striped table-responsive ">
                        <thead>
                        <tr>
                            <th><spring:message code="cv.school"/></th>
                ...
                <div class="bs-callout bs-callout-danger">
                    ...
                    <ul class="list-group">
                        <c:forEach items="${cv.languages}" var="item">
                            <li class="list-group-item"><c:out value="${item.lang}"/> - <c:out
                                    value="${item.level}"/></li>
                ...
                <div class="bs-callout bs-callout-danger">
                    ...
                    <ul class="list-group">
                        <c:forEach items="${cv.skills}" var="item">
                            <li class="list-group-item"><c:out value="${item.title}"/> - <c:out
                                    value="${item.value}"/></li>
                        </c:forEach>
                    </ul>
                </div>
                        ...
                        <form action="${pageContext.request.contextPath}/auth/download" method="get" target="_blank">
                            ...
                            <div class="col-md-8">
                                <button class="btn-lg btn-default" type="submit">
                                    <span class="glyphicon glyphicon-save-file">Download PDF</span>
                                </button>
                            </div>
                        </form>
                    </div>
