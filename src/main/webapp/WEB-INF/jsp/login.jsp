        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <c:if test="${not empty logout}">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-offset-3 col-sm-9"
                             style=" color: red;margin-top: 50px;  margin-bottom: 50px"><spring:message
                                code="BeRedirected"/></div>
                    </div>
                ...
                <c:if test="${empty logout}">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" name='loginForm'
                            ...
                            <div class="form-group">
                                <label for="inputUsername" class="col-sm-3 control-label"><spring:message
                                        code="Username"/></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group last">
                                <div class="col-sm-offset-3 col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-success btn-sm"><spring:message
                                            code="LogIn"/></button>

                                    <a  class="btn btn-default btn-sm" style=""
                                       href="${pageContext.request.contextPath}/index">
                                        <span class="glyphicon glyphicon-log-in"></span> Back to index
                                    </a>
                    ...
                    <div class="panel-footer">Not Registered? <a href="${pageContext.request.contextPath}/register"
                                                                 class=""><spring:message code="RegisterHere"/></a>
                    </div>
                </c:if>
            </div>
        </div>
